...
const TRAITS = [
  {
    ...
    text: 'Более 10 лет практики в мужских стрижках и оформлении бороды.',
  },
  {
    icon: '🎯',
  ...
  },
  {
    ...
    text: 'Приводите с собой детей — найдём время и подход для маленьких клиентов.',
  },
  {
    icon: '🐕',
    title: 'Можно с собаками',
    text: 'Заходите вместе с четвероногим другом — места хватит на всех.',
  },
];
      ...
      <div className="container hero__inner">
        ...
        >
          ...
          <p className="hero__text">
            Персональный мастер Barbershop. Создаю индивидуальный стиль,
            выполняю классические и современные мужские стрижки, уделяю
            внимание деталям и качеству результата.
          </p>
